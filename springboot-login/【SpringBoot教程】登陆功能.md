...
![在这里插入图片描述](https://i-blog.csdnimg.cn/blog_migrate/828ea8a6b0da52a990524b10901045d9.png#pic_center)
...
- **Authorization Code（授权码模式）**：正宗的`OAuth2`的授权模式，客户端先将用户导向认证服务器，认证用户成功后获取授权码，然后进行授权，最后根据授权码获取访问令牌；
...
![QQ_1745136738515](./assets/QQ_1745136738515.png)

![QQ_1745136746197](./assets/QQ_1745136746197.png)
